...
/**
 * Variation Carousel for WooCommerce
 *
 ...
 *
 * @class DRO_Variation_Carousel_Dependencies
...
class DRO_Variation_Carousel_Dependencies {
	...
	public static function get_php_notice() {
		...
		return sprintf(
			esc_html__( 'The minimum PHP version required for this plugin is %1$s. You are running %2$s.', 'dro-vcw' ),
	...
	public static function get_wp_notice() {
		...
		return sprintf(
			esc_html__( '%1$s is not active, as it requires WordPress version %2$s or higher. Please %3$supdate WordPress &raquo;%4$s', 'dro-vcw' ),
			'<strong>' . DRO_Variation_Carousel()->plugin_name . '</strong>',
	...
	public function get_wc_notice() {
		...
		return sprintf(
			esc_html__( '%1$s is not active, as it requires WooCommerce version %2$s or higher. Please %3$supdate WooCommerce &raquo;%4$s', 'dro-vcw' ),
			'<strong>' . DRO_Variation_Carousel()->plugin_name . '</strong>',
